...
class Property(models.Model):
    ...
    closed_parking = models.CharField(max_length=450, null=True)
    blockarea = models.CharField(max_length=450, null=True)
    building_type = models.CharField(max_length=450, null=True)
    view = models.CharField(max_length=450, null=True)
    locality = models.CharField(max_length=450, null=True)
    additional_rooms = models.CharField(max_length=450, null=True)
    possession_status = models.CharField(max_length=450, null=True)
    bathroom = models.CharField(max_length=450, null=True)
